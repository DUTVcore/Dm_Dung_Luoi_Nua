...
* **📅 Future-Ready Task Manager:**
    * **Lên kế hoạch:** Hỗ trợ thêm nhiệm vụ cho các ngày trong tương lai.
    * **Quản lý dài hạn:** Giúp bạn sắp xếp công việc cho ngày mai hoặc tuần sau để không bao giờ bị "deadline dí".
* **⏰ Precision Timing (Tùy chọn):**
    * **Module quản lý giờ:** Cho phép gán giờ cụ thể cho từng nhiệm vụ.
    * **Chế độ Bật/Tắt:** Tính năng này có thể tùy chỉnh. Dùng chế độ "Hardcore" để kỷ luật từng phút, hoặc tắt đi để giao diện thoáng hơn.
* **🎨 Deep Customization:** Mở rộng khả năng tùy biến (Fonts, UI Scaling, độ mờ...). Biến Dashboard thành phong cách riêng của bạn.
* **🎬 Dynamic Background:**
...
* **📝 Fast Todo-list:** Lưu trữ công việc vào LocalStorage. Tắt trình duyệt không mất dữ liệu.
* **⚙️ Quick Settings:** Giao diện cài đặt dạng Modal kính mờ (Glassmorphism), thao tác mượt mà.
...
- [x] Lưu trữ dữ liệu LocalStorage.

### Giai đoạn 2: Tối ưu hiệu suất (Hiện tại)
- [ ] **Future Task Scheduler:** Lên lịch task cho ngày mai/tuần sau.
- [ ] **Time Management Module:** Tùy chọn bật/tắt hiển thị giờ cho task.
- [ ] **Extended Personalization:** Thêm các tùy chọn chỉnh sửa giao diện sâu hơn.
...
**DUTVcore**
* Sinh viên Đại học Bách Khoa Đà Nẵng (DUT).
* Chuyên ngành: Kỹ thuật Máy tính (Computer Engineering).
* Sở thích: Phần cứng PC, Overclocking, Hệ thống nhúng.
